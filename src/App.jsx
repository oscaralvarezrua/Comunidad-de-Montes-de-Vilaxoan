...
const ESCUDO_URL = "/Comunidad-de-Montes-de-Vilaxoan/escudo-vilaxoan.png"; // Usar la misma imagen para header y footer
  ...
  return (
    <div className="landing-container">
      <header className="landing-header">
        ...
        <div className="lang-switcher">
          <button onClick={() => i18n.changeLanguage("es")} className="btn-espana">
            <img src="/Comunidad-de-Montes-de-Vilaxoan/5353-espana.png" alt="Español" className="icon-espana" />
          </button>
          <button onClick={() => i18n.changeLanguage("gl")} className="btn-galicia">
            <img src="/Comunidad-de-Montes-de-Vilaxoan/5353-galicia.png" alt="Gallego" className="icon-galicia" />
          </button>
        </div>
      </header>
      ...
      <footer className="landing-footer">
        <img src="/Comunidad-de-Montes-de-Vilaxoan/escudo-vilaxoan.png" alt="Escudo de Vilaxoán" className="escudo-footer" />
